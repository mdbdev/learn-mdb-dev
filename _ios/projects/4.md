...
- The current weather condition
    - We ask you to be creative with this one. You can use an icon, background, animation, etc. **Displaying the condition in plain text will receive 50% credits.**
