...
Since different iOS device may have different screen size (iPhone 12 Pro Max: 428×926 points; iPhone XR: 414×896 points), aligning the views can be tedious and oftentimes tricky. Most of the time it often involves dynamcally computing all the values. For example, if we want our 200×70 label to be at the center of every screen, we would have to do this
