...
- Since different iOS device may have different screen size, aligning the views can be tricky and tedious, and it often involves dynamcally computing all the values. For example, if we want our 200x70 label to be at the center of every screen, we would have to do this
